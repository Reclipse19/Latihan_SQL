...
public class MainFragment extends Fragment implements
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnsubmit) {
            ...
            if (name.isEmpty() || ageStr.isEmpty()) {
                Toast.makeText(context, "Masukan Nama Dan Umur", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                // Set text color to red after submission
                edtName.setTextColor(getResources().getColor(android.R.color.holo_red_dark));
                edtAge.setTextColor(getResources().getColor(android.R.color.holo_red_dark));
    ...
    public void onUserClick(PersonBean currentPerson, String action) {
        if (action.equals("Edit")) {
            ...
            edtAge.setText(String.valueOf(currentPerson.getAge()));
